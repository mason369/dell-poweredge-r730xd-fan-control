...
- El código fuente actual es `1.1.0`. El Release `v1.1.0` se genera desde la etiqueta correspondiente y los exe/dll del paquete tienen la versión de archivo `1.1.0.0`.
