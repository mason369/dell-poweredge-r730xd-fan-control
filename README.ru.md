...
- Текущая версия исходного кода — `1.1.2`. Последним опубликованным Release остаётся `v1.1.0`, а версия файлов exe/dll в его пакете — `1.1.0.0`; `1.1.2` станет официальным Release только после сборки соответствующего тега.
