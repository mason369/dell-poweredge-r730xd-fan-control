...
- Текущий исходный код и последний опубликованный Release имеют версию `v1.1.3`; версия файлов exe/dll в пакете — `1.1.3.0`, поэтому исходный код, тег и бинарные файлы указывают одну версию.
