...
- Den aktuelle kildekode og den senest udgivne Release er `v1.1.3`; pakkens exe/dll har filversion `1.1.3.0`, så kildekode, tag og binære filer angiver samme version.
