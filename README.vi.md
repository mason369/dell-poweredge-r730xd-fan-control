...
- Mã nguồn hiện tại và Release mới nhất đã phát hành đều là `v1.1.3`; các tệp exe/dll trong gói có phiên bản `1.1.3.0`, nên mã nguồn, tag và tệp nhị phân cùng chỉ một phiên bản.
