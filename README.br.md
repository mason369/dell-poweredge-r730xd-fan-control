...
- O código-fonte atual é `1.1.2`. O Release publicado mais recente ainda é o `v1.1.0`, cujos arquivos exe/dll têm versão `1.1.0.0`; a versão `1.1.2` só se torna um Release oficial após a criação da tag correspondente.
