...
- O código-fonte atual e o Release publicado mais recente são `v1.1.3`; os arquivos exe/dll do pacote têm versão `1.1.3.0`, portanto o código-fonte, a tag e os binários identificam a mesma versão.
