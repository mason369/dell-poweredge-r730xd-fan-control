...
- Aktualny kod źródłowy i najnowszy opublikowany Release mają wersję `v1.1.3`; pliki exe/dll w paczce mają wersję `1.1.3.0`, więc kod, tag i pliki binarne wskazują tę samą wersję.
