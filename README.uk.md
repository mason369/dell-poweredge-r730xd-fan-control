...
- Поточний код має версію `1.1.2`. Останнім опублікованим Release залишається `v1.1.0`, а файли exe/dll у його пакеті мають версію `1.1.0.0`; `1.1.2` стане офіційним Release лише після складання відповідного tag.
