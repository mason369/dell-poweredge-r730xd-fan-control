...
- Поточний код і останній опублікований Release мають версію `v1.1.3`; файли exe/dll у пакеті мають версію `1.1.3.0`, тому код, tag і двійкові файли вказують ту саму версію.
