...
- Gjeldende kildekode og den nyeste publiserte releasen er `v1.1.3`; pakkens exe/dll har filversjon `1.1.3.0`, slik at kildekode, tagg og binærfiler viser samme versjon.
