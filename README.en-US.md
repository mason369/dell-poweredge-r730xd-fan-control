...
| Current GitHub Release | The latest published release is `v1.1.2`; its zip contains exe/dll file version `1.1.2.0`, and the source commit, tag, GitHub Release, and packaged binaries identify the same version. Do not update only the Release title or reuse older binaries. |
