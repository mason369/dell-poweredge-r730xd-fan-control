...
- Presets can be switched directly, and custom manual percent rules can be added, saved, and deleted; the UI shows the current running mode.
- Dell automatic fan mode remains available as a separate action and as a preset entry.
