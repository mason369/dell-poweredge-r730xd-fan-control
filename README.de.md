...
- Der aktuelle Quellcode und das neueste veröffentlichte Release haben Version `v1.1.3`; die exe/dll im Paket tragen Dateiversion `1.1.3.0`, sodass Quellcode, Tag und Binärdateien dieselbe Version ausweisen.
