...
- Der aktuelle Quellcode und das neueste veröffentlichte Release haben Version `v1.1.2`; die exe/dll im Paket tragen Dateiversion `1.1.2.0`, sodass Quellcode, Tag und Binärdateien dieselbe Version ausweisen.
